"""Authors: Cody Baker, Ben Dichter and Julia Sprenger"""
import warnings
...
class NeuralynxRecordingInterface(BaseRecordingExtractorInterface):
    ...
    def __init__(self, folder_path: FolderPathType, verbose: bool = True):
        ...
        extractors = []
        seg_index = 0
        # generate one extractor for each neo recording segment
        ...
        for i, extractor in enumerate(extractors):
            ...
            self.recording_extractor.set_channel_property(i, "filtering", filter_info)
